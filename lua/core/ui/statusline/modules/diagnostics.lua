...
function M.setup()
  ...
  local errors_fmt = (errors and errors > 0) and ("%#DiagnosticVirtualTextError#  " .. errors .. " ") or ""
  local warnings_fmt = (warnings and warnings > 0) and ("%#DiagnosticVirtualTextWarn#  " .. warnings .. " ") or ""
